...
<ul id="myTab" class="nav-tabs" style=" margin-top:30px; height:28px; list-style:none;">
	<li  ><a href="<?php echo U('AttendanceSet/boarders_index');?>" style="color:#1f1f1f;text-decoration: none;" >住校生考勤设置</a></li>
	<li class="active"><a href="<?php echo U('AttendanceSet/not_boarders');?>" style="color:#1f1f1f;text-decoration: none;" class="touch">非住校生考勤设置</a></li>
</ul>
<div class="" style="margin-left: 25px; margin-right: 20px; color: black;">
<form action="<?php echo u('AttendanceSet/not_boarders_post');?>" method="post">
