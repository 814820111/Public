...
<div class="wrap jj">
    <ul class="nav nav-tabs">
			...
			<li class="active"><a href="<?php echo U('Student/student');?>">批量导入学生</a></li>
			<!--<li><a href="<?php echo U('Import/student');?>">批量导入学生</a></li>-->
			<!--<li><a href="<?php echo U('Import/teacherclass');?>">批量导入任课班级</a></li>-->
    </ul>
<div class="common-form">
        <form method="post" class="form-horizontal" action="<?php echo U('student_post');?>"  enctype="multipart/form-data"  onsubmit = "return check()">
            <fieldset>
                ...
                <div class="control-group">
							...
							<label class="control-label">*注意</label>
								<div class="controls">
								仅允许上传后缀名为 .xls 或 .xlsx 的文件. <a href="/weixiaotong2016/statics/excel/student.xlsx">模板文件下载</a>
								</div>
							</div>
