...
<![endif]-->
<link rel="stylesheet" href="/weixiaotong2016/statics/simpleboot/themes/<?php echo C('SP_ADMIN_STYLE');?>/simplebootadminindex.min.css?">
<!--[if lte IE 8]>
...
<body style="min-width:900px;" screen_capture_injected="true">
	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				<a href="/weixiaotong2016/index.php?g=admin&m=index&a=index" class="brand">
					<small>
				<img height="26px" src="/weixiaotong2016/tpl_admin/simpleboot/assets/images/logo-4.png">
						SA管理平台
				</small>
				</a>
	...
	<script src="/weixiaotong2016/tpl_admin/simpleboot/assets/js/index.js"></script>
