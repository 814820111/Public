...
<div class="wrap J_check_wrap">
    ...
    <div class="common-form">
        <form class="well form-search" method="post" action="<?php echo U('DeviceManage/device_online');?>" r>
            ...
            <div class="mb10">
                ...
                <a class="btn btn-danger" href="<?php echo U('device_online');?>">清空</a>
        ...
        <form method="post" class="J_ajaxForm" action="#">
            ...
            <table width="100%" class="table table-hover table-bordered table-list ">
                ...
                <tr>
                    ...
                    <th style="min-width:80px">设备连通状态</th>
                    <th style="min-width:50px">最后正常连接时间</th>
                ...
                <?php if(is_array($ads)): foreach($ads as $key=>$vo): ?><tr>
                        ...
                        <td><?php echo ($vo["connected_status"]); ?></td>
                        <td><?php echo ($vo["lasttime"]); ?></td><?php endforeach; endif; ?>
                </tbody>
            </table>
        </form>
