...
<div class="wrap J_check_wrap">
    ...
    <form class="well form-search" method="post" action="<?php echo U('MonitorTeacherWeb/index');?>">
        <div class="mb10">
            ...
            <input type="button" class="btn btn-warning" value="重置" onclick="urls('MonitorTeacherWeb/index')" />
        </div>
    </form>
    <table class="table table-hover table-bordered" style="table-layout:fixed">
        ...
        <?php if(is_array($lists)): foreach($lists as $key=>$vo): ?><tr>
                ...
                <td>
                    <a class="" href="<?php echo U('MonitorTeacherWeb/look',array('id'=>$vo['monitor_id']));?>">更改授权</a>
