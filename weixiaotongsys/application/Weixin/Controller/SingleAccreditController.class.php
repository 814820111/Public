...
class SingleAccreditController extends WeixinbaseController
{
//第一步：用户同意授权，获取code
function accept(){
...
//        $_SESSION["schoolid"] = $schoolid;
        ...
        if($result){
            ...
            $REDIRECT_URI = "$http/index.php/weixin/SingleAccredit/getCode";
...
//    echo $url;
    ...
    session_write_close();
    $http = "http://".$_SERVER['HTTP_HOST'].__ROOT__;
    header("location:".$http."/index.php/weixin/SingleSession/index");
