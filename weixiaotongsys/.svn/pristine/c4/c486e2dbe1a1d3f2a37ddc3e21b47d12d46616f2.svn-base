...
<div class="wrap jj">
    <ul id="myTab" class="nav-tabs" style=" margin-top:30px; height:30px; list-style:none;">
        ...
        <li class="active">
            <a href="<?php echo U('abnormal');?>" style="color:#1f1f1f; text-decoration:none; padding:10px 15px;">开设选修班</a>
        </li>
    ...
    <div style=" background-color:rgba(0,0,0,0.7);    position: fixed; top: 0;right: 0;bottom: 0; left: 0;z-index: 1040; display: none;" class="daitan"  >
        <div style=" width:850px;height: 400px;overflow: auto; background-color:white; margin-left:auto; margin-right:auto; margin-top:5%; padding:20px; position:relative;">
            <form id="form2" action="" method="post">
                <div id="top" style="width:100%;float:left;">
                    ...
                    <table class="gridtable" align="left" style="margin-top: 20px;">
                        ...
                        <tr>
                            ...
                            <td class="value-txt">
                                <div class="select_style">
                                    <select name="subject" id="subject" class="drop-down" onchange="getSubject(this);">
                        ...
                        <tr>
                            ...
                            <td class="value-txt">
                                <div class="select_style">
                                    <select name="teacher" id="teacher" class="drop-down" onchange="getTeacher(this);">
                            ...
                            <td class="value-txt">
                                <div class="select_style">
                                    <select name="classroom" id="classroom" class="drop-down" onchange="getSetting(this);">
                            ...
                            <td class="value-txt">
                                <div class="select_style">
                                    <input type="text" name="sum" id="sum" style="border: 1px solid #dce4ec;    height: 16px;    width: 188px;">
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td class="title-txt"><span>简介</span></td>
                            <td colspan="10"><textarea style="width: 98%;float: left;" rows="5"  name="courseIntroduce" id="courseIntroduce" placeholder="100个字以内的课程介绍....."></textarea></td>
                ...
                <div style=" width:60px; margin-left:auto; margin-right:auto; margin-top:20px;">
                    <input type="button" value="保&nbsp;存" style=" border:none; background-color:#26a69a; color:white; border-radius:3px; padding:5px 15px 5px 15px;" onclick='AddClassNode()'>
...
<div style=" background-color:rgba(0,0,0,0.7);    position: fixed; top: 0;right: 0;bottom: 0; left: 0;z-index: 1040; display: none;" class="student_num"  >
    ...
    <div id="myTabContent" class="tab-content" style=" padding-left:30px; padding-right:30px;">
        <div class="tab-pane fade in active" id="home">
            <br/>
            <form class="form-horizontal J_ajaxForm" action="<?php echo u('set_node');?>" method="get" style="margin: 0px 0px 5px;">
                    ...
                    <div class="mb10">
                      ...
                      <input type="submit" style=" border:none; background-color:#26a69a; color:white; border-radius:5px; padding:5px 10px 5px 10px;" value="搜索" />
                       ...
                       <input type="button"  value="添加设置" style=" border:none; background-color:#26a69a; color:white; border-radius:5px; padding:5px 10px 5px 10px; cursor: pointer;" class="drop" >
                                    <input type="hidden" name="id" value="<?php echo ($selection); ?>">
                    </div>
                ...
                <table class="table table-hover table-bordered table-list">
                    ...
                    <?php if(is_array($elective)): foreach($elective as $key=>$vo): ?><tr>
                            ...
                            <td class="pai2">
                                ...
                                <a  class="J_ajax_del"  href="<?php echo U('node_delete',array('id'=>$vo['id']));?>"  style=" color:#00c1dd;cursor: pointer;" >
                                    删除
                                </a>
                            </td>
                  ...
                  if(res.msg=='no')
                  {
                      ...
                      $("#occupyTable").find("td").each(function (i) {
                          for (var i = 0; i < node.length; i++) {
                              ...
                              if($(this).find("span").text() == node[i]['class_position'])
                              {
                                  $(this).css("background-color","#ccff99");
                                  $(this).find(".tdText").text("");
                                  alert("老师上课时间冲突:"+node[i]['china_node']+",该老师已有授课");
                              }
                          }
                      });
                      var xuankeStrs = "";
                    ...
                    return  isconfilt = false;
                  }
                  return    isconfilt = true;
