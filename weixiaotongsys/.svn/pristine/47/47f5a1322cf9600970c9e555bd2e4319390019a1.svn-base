...
//        $guanzhu_res = $this->https_request($url);
//        $guanzhu_res = json_decode($guanzhu_res,true);
//        if ($guanzhu_res['subscribe'] == 1){
//            echo "<script>alert('谢谢您的关注!!')</script>";
