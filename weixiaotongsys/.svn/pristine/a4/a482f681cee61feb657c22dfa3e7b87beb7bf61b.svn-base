...
<div class="wrap jj">
    <ul id="myTab" class="nav-tabs" style=" margin-top:30px; height:30px; list-style:none;">
        <li class="active">
            <a href="<?php echo U('index');?>" style="color:#1f1f1f; text-decoration:none; padding:10px 15px;">学生违纪</a>
        </li>

        <li class="">
            <a href="<?php echo U('abnormal');?>" style="color:#1f1f1f; text-decoration:none; padding:10px 15px;">异动管理</a>
        </li>
            ...
            <form class="form-horizontal J_ajaxForm" action="<?php echo u('index');?>" method="get" style="margin: 0px 0px 5px;">
                <div class="search_type cc mb10">
                    <div class="mb10">
                      ...
                      学生姓名:
                      <input type="text" class="select_2" name="student_name" placeholder="-请输入-" style="width:8%; height: 15px;border-width:1px;" value="<?php echo ($studentname); ?>"> &nbsp;&nbsp;
                      学生学号:
                      <input type="text" class="select_2" name="student_card" placeholder="-请输入-" style="width:8%; height: 15px;border-width:1px;" value="<?php echo ($studentcard); ?>"> &nbsp;&nbsp;<br>
                      <div style="display: inline-block; margin-top: 5px;">
                      家长手机号:
                      <input type="text" class="select_2" name="phone" placeholder="-请输入-" style="width:120px; height: 15px;border-width:1px;" value="<?php echo ($parent_phone); ?>">
                      <input type="submit" style="border:none; background-color:#26a69a; color:white; border-radius:5px; padding:5px 10px 5px 10px;" value="搜索" />
                       ...
                       <input type="button"  value="添加违纪"  onclick="add_illegality()" style=" border:none; background-color:#26a69a; color:white; border-radius:5px; padding:5px 10px 5px 10px; cursor: pointer;" class="add_illegality" >
                       <input type="button"  value="管理违纪类别" style=" border:none; background-color:#26a69a; color:white; border-radius:5px; padding:5px 10px 5px 10px; cursor: pointer;" class="Illegality_manage" >
                ...
                <div class="table-responsive">
                    <table class="table table-hover table-bordered table-list">
                        ...
                        <tr style="background-color:#CCC;">
                            <th class="pai" style=" border-left: none;border-width: 0.5px;"> <input type='checkbox' id='checkAll' name="checkAll" style="    vertical-align: -2px;"> 选择</th>
...
<script>
    ...
    $(".Illegality_manage").click(function(){

        location.href="/weixiaotong2016/index.php?g=teacher&m=Illegality&a=Illegality_manage"

    })

//    $(".add_illegality").click(function(){
//        alert("添加违纪");
//
//    })

    //添加违纪
    function add_illegality() {
        ...
        layui.use(['layer'], function() {
            ...
            var index = layer.open({
                ...
                offset : ['20px', '200px'],
                maxmin: true,
                content: "<?php echo U('Illegality/add_illegality');?>",
    ...
    $(".drop_student").click(function(){
        ...
        $.ajax({
            type:'get',
            url: "<?php echo U('Teacher/AdjustClass/student_move');?>",
            dataType:'json',
            data: {
                'ids': ids,
                'classid':cids,
    ...
    $('.del_class').click(function(){
        ...
        $.ajax({
            type:'get',
            url: "<?php echo U('Teacher/AdjustClass/edit_class');?>",
            dataType:'json',
            data: {
                'ids': ids,
                'classid':classid,
