...
<div class="">
    <ul id="myTab" class=" nav-tabs" style=" margin-top:30px; height:30px; list-style:none;">
        ...
        <li class="active"><a href="<?php echo U('lists');?>" style="color:#1f1f1f; text-decoration:none; padding:10px 15px;">创建考勤</a></li>
    </ul>
    <div id="myTabContent" class="tab-content" style=" padding-left:30px; padding-right:30px;">
                        ...
                        <div class="c_selector_left" style="height:315px; width: 245px;background-color: ; float:left;">
                            ...
                            <div class="body_left" style="height: 260px;overflow: auto;">
                               <div class="selector_left">
                                ...
                                <div class="ding_selector_navbar" style=" padding: 5px 11px; font-size: 12px; margin-top:-5px;" ><input type="checkbox"  class="x_quan" style="vertical-align: -3px;">全选</span></div>
                                <div class="selector_main" style="padding: 0px 11px; font-size: 12px;">
                                    <li>
                                        <label><input type="checkbox" style="vertical-align: -3px;"></label>
                                        <span>个人</span>
        ...
        <div class="tab-pane fade in active" id="home" style="margin-bottom: 50px;">
            ...
            <form class="form-horizontal J_ajaxForm" action="<?php echo u('add_group_post');?>" method="post" name="myform">
                ...
                <div class="kong">
                    <div class="fixation-div" style="display:block;">
                    ...
                    <div class="schedule-div" style="display:none;">
                        ...
                        <div class="scheduling-display" style="width: 500px;float: left;display: none;" onclick="get_scheduling()">
                        </div>
                        <input type="button" class="ant-btn scheduling_att" value="选择班次" style="" onclick="get_schedule()" >
                ...
                <div class="kong scheduling-period" style="display: none;">
                    <div class="" >
                        <div style=" width:80px; float:left; text-align:right;">排班周期：</div>
                        <input name="scheduling" class="scheduling" type="hidden">

                        <input type="button" class="ant-btn scheduling_a"  value="请设置排班周期" style="margin-left: 14px;" onclick="get_schedule_set()" >
                        <div id="scheduling-period-div" style="width:400px;float:left; display: none;">
                        ...
                        <form id="form3" action="" method="post">
                            <div id="" style="width:100%;float:left; margin-top: 20px;">
                                ...
                                <div class="modal-body" style="border-top: 1px solid #e9e9e9; border-bottom: 1px solid #e9e9e9;">
                                    ...
                                    <div class="ant-form-item" style="line-height: 30px;">
                                        <div class="ant-form-item-label" style="float: left;">
                                            <label style="float: right;    line-height: 30px;">第1天:</label>
                                        </div>
                                        <div class="col-md-10 select_schedule" style="float: left;"><select name="schedule_period[]"></select></div>

                                    </div>
                                    <div class="ant-form-item" style="line-height: 30px;">
                                        <div class="ant-form-item-label" style="float: left;">
                                            <label style="float: right;  line-height: 30px;">第2天:</label>
                                        </div>
                                        <div class="col-md-10 select_schedule" style="float: left;"><select name="schedule_period[]"></select></div>
...
//                $(".person_body").children().remove();
                ...
                var checkbox = "";
                 if(type==1)
                 {
                     var checkbox = "<input id='geren_check' type='checkbox' style='vertical-align:-3px;' data-type='1' onclick=javascript:checknode(this); name='one_person[]' value=1 "+checked+">";
                 }else{
                     var checkbox = "";
                 }
                 if(type==2)
...
//                one_person+="<label style='display: inherit; font-weight:normal;font-size: 12px;' >";
//                one_person+="<span>"+checkbox+"</span>";
//                one_person+="<span>个人</span>";
...
//                one_person+="</label>";
               ...
               var teacher_info = res.teacher_info;
                ...
                for(var i = 0; i<department.length; i++)
                {
                    ...
                    if(type==1)
                    {
                        ...
                        var fen_checkbox = "<input id='fenzu_"+department[i]['id']+"' type='checkbox' style='vertical-align:-3px;' data-type='1' onclick=javascript:checknode(this); name='one_person[]' value="+department[i]['id']+" "+fen_checked+">";
                    }else{
                        fen_checkbox = "";
                        var fenzu = "style='color:rgb(56, 173, 255); float: right;cursor: pointer' onclick='sub_level("+department[i]['id']+",1)'"
                    }
    ...
    $(document).on('click', '.selector_main label', function(){
     var aa = ($(this).find('label').find("input").val());
console.log(aa);
    ...
    function checknode(obj)
    {
       ...
       if(is_true)
       {
           if(type==1)
           {
               ...
               {
                   $(".no_att_userid").val(att_userid+id+",");
               }
//               $(".att_userid").val(att_userid+id+",");
           }
...
$("input[name='schedule']").click(function(){
     ...
     if(id==1)
     {
         ...
         if(scheduling)
         {
             $(".scheduling-period").css("display","block");
         }
        ...
        $.ajax({
            ...
            success: function(res) {
                if(res.status)
                {
                   ...
                   {
                      html+="<tr>";
                      html+="<td><input type=radio name=scheudle value="+scheudle[i]['id']+"></td>";
