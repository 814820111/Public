...
<div align="center">
    <div id="myTabContent" class="tab-content" style="overflow-x: hidden;">
        <div class="tab-pane fade in active" id="home">
            <br/>
            <form class="form-horizontal J_ajaxForm" action="<?php echo u('Dormitory/dormitory_add_student_bed');?>" method="get" style="margin: 0px 0px 5px;">
                <div class="search_type cc mb10">
                    <div class="mb10">
                  <span class="mr20" style="float:left;margin-bottom: 10px;">学生姓名：
                    <input type="text" value="<?php echo ($name); ?>" class="select_2" name="name" placeholder="-学生姓名-" style="width:80px; height: 15px;border-width:1px;">
            ...
            <div class="table-responsive">
                <table class="table table-hover table-bordered table-list">
                    ...
                    <?php if(is_array($studentlist)): foreach($studentlist as $key=>$vo): ?><tr>
                        ...
                        <td style="text-align: center;"><input type="radio" name="studentid"  value="<?php echo ($vo["studentid"]); ?>" title="<?php echo ($vo["stu_name"]); ?>"></td>
                        <td style="text-align: center;"><?php echo ($classname); ?></td>
