...
<div class="wrap jj">
    <ul class="nav nav-tabs">
			<li><a href="<?php echo U('index');?>">学生信息管理</a></li>
			<li><a href="<?php echo U('student/add',array('school'=>empty($term['schoolid'])?'':$term['schoolid']));?>" target="_self">添加学生</a></li>
			<li class="active"><a href="<?php echo U('Student/idupload');?>">批量导入学生卡号</a></li>
			<!--<li><a href="<?php echo U('Import/student');?>">批量导入学生</a></li>-->
			<!--<li><a href="<?php echo U('Import/teacherclass');?>">批量导入任课班级</a></li>-->
    </ul>
<div class="common-form">
        <form method="post" class="form-horizontal" action="<?php echo U('idupload_post');?>"  enctype="multipart/form-data"  onsubmit = "return check()">
            <fieldset>
					...
					<div class="control-group">
						...
						<div class="controls">
							<label class="radio-inline">
								<input type="radio" name="optionsRadiosinline" id="" value="option1" checked> 模式 1&nbsp&nbsp&nbsp
								<input type="radio" name="optionsRadiosinline" id=""  value="option2"> 模式 2
							</label>
						</div>
					</div>
							<div class="control-group">
							...
							<label class="control-label">*注意</label>
								<div class="controls">
								仅允许上传后缀名为 .xls 或 .xlsx 的文件. <br><a href="/weixiaotong2016/statics/excel/studentcard1.xlsx">模式一模板下载</a><br>
									<a href="/weixiaotong2016/statics/excel/studentcard2.xlsx">模式二模板下载</a>
								</div>
							</div>
							...
							<!-- <label class="label label-danger">数据导入结果：</label> -->
								...
								数据总行数:<?php echo ($allcount); ?>,其中[更新数据:<?php echo ($successcount); ?>条]
								</div>
