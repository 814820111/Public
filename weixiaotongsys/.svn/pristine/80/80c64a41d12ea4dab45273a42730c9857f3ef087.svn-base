...
<div class="" style="margin-left: 20px; margin-right: 20px;">
    <ul id="myTab" class="nav-tabs" style=" margin-top:30px; height:30px; margin-left: 0;">
   		<li class="active"><a href="<?php echo U('lists');?>" style="color:#1f1f1f;text-decoration:none; padding:10px 15px;">考勤信息查询</a></li>
      <li><a href="<?php echo U('error');?>" style="color:#1f1f1f; text-decoration:none; padding:10px 15px;" class="touch">异常考勤查询</a></li>
   	</ul>
   	<div id="myTabContent" class="tab-content">
		<div class="tab-pane fade in active" id="home">
        	<br/>
			<form class="form-horizontal J_ajaxForm" action="<?php echo u('lists');?>" method="get" style="margin:0px 0px 0px;">
          <div class="search_type cc mb10">

              <div class="mb10">
                  <span class="mr20">
                     时间选择：
                      <input type="text" class="J_date date" name="begintime" placeholder="-选择时间-" style="width:9%; height: 17px; border-width: 1px; color: black;" value="<?php echo ($begin); ?>">  至  <input type="text" class="J_date date" name="endtime" placeholder="-选择时间-" style="width:9%; height: 17px; border-width: 1px; color: black;" value="<?php echo ($end); ?>"> &nbsp; &nbsp;
                     班级:
                     <select class="select_2" name="class" style=" width: auto;">
                      ...
                      &nbsp; &nbsp;
                      家长姓名： 
                      <input type="text" class="select_2" name="par_name" placeholder="-请输入姓名-" style="width:100px; height: 17px; border-width: 1px; color: black;" value="<?php echo ($par_name); ?>">
                      &nbsp; &nbsp;<br>
                      手机号码： 
                      <input type="text" class="select_2" name="phone" placeholder="-请输入手机号-" style="width:150px; height: 17px; border-width: 1px; margin-top: 6px; color: black;     margin-bottom: 2px;" value="<?php echo ($phone); ?>">
                      &nbsp; &nbsp;
                      <input type="radio" class="input" name="time_a" value="1" <?php echo ($time_a==1?'checked':''); ?>><span style="vertical-align: -2px;">上午上学</span>
                      <input type="radio" class="input" name="time_a" value="2" <?php echo ($time_a==2?'checked':''); ?>><span style="vertical-align: -2px;">上午放学</span>
                      <input type="radio" class="input" name="time_a" value="3" <?php echo ($time_a==3?'checked':''); ?>><span style="vertical-align: -2px;">下午上学</span>
                      <input type="radio" class="input" name="time_a" value="4" <?php echo ($time_a==4?'checked':''); ?>><span style="vertical-align: -2px;">下午放学</span>
                      <input type="radio" class="input" name="time_a" value="5" <?php echo ($time_a==5?'checked':''); ?>><span style="vertical-align: -2px;">晚上上学</span>
                      <input type="radio" class="input" name="time_a" value="6" <?php echo ($time_a==6?'checked':''); ?>><span style="vertical-align: -2px;">晚上放学</span>
      ...
      <form class="J_ajaxForm" action="" method="post">
            <div class="table-responsive">
                      <table class="table table-bordered table-list">
                        ...
                        <?php if(is_array($arr)): foreach($arr as $key=>$vo): if($vo['attendancetype'] == null): else: ?>
                        <tr>
                           ...
                           <td style=" text-align: center;border-width: 0.5px;"><?php echo ($vo["attendancetype"]); ?></td>
