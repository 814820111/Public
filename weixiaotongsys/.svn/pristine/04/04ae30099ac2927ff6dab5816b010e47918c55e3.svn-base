...
<div class="wrap J_check_wrap">
    <ul class="nav nav-tabs">
        <li class="active"><a href="<?php echo U('index');?>">老师授权管理</a></li>
        <li><a href="<?php echo U('add');?>">新增老师授权</a></li>
    </ul>
    <form class="well form-search" method="post" action="<?php echo U('MonitorTeacher/index');?>">
        <div class="mb10">
    ...
    <table class="table table-hover table-bordered" style="table-layout:fixed">
        ...
        <?php if(is_array($lists)): foreach($lists as $key=>$vo): ?><tr>
                ...
                <td  style="overflow:hidden;white-space:nowrap;text-overflow:ellipsis;-moz-text-overflow: ellipsis;">
                    <div title="<?php echo ($vo["monitor_nname"]); ?>" style="width: 100%;height: 100%;text-overflow: ellipsis;overflow: hidden;">
                        <?php echo ($vo["monitor_nname"]); ?>
                    </div>
                </td>
                <td>
                    <a class="" href="<?php echo U('MonitorTeacher/look',array('id'=>$vo['monitor_id']));?>">更改授权</a>
                   ...
                   <button type="button" class="btn btn-danger" onclick="alertMsg('Monitor/deleteMonitors',<?php echo $vo['id']?>)">删除</button>  -->
                    <a class="" href="<?php echo U('MonitorTeacher/editTime',array('id'=>$vo['monitor_id']));?>">修改开发时间</a>
                    <a class="J_ajax_del" href="<?php echo U('MonitorTeacher/delete',array('id'=>$vo['monitor_id']));?>">删除</a>
                    <br /> 
                </td>
