...
<div class="wrap J_check_wrap">
  ...
  <form id ="cc" class="J_ajaxForm" action="<?php echo U('SchoolRole/authorize_post');?>" method="post">
    ...
    <div class="form-actions">
        ...
        <input type="hidden" name="citys" value="<?php echo ($citys); ?>" />
        <input type="hidden" name="new_message_type" value="<?php echo ($new_message_type); ?>" />
        

    	<input type="hidden" name="schoolid" value="<?php echo ($schoolid); ?>" />

        <button class="btn btn_submit btn-primary mr10 J_ajax_submit_btn" type="submit">授权</button>
        <!--<a class="btn" href="/weixiaotong2016/index.php/Admin/SchoolRole">返回</a>-->
        <a class="btn" href="<?php echo U('SchoolRole/index',get_condition_cache($only_code));?>">返回</a>
   	</div>
  </form>
</div>
<script type="text/javascript">
