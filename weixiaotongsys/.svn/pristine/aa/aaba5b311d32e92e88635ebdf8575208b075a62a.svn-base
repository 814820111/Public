...
$configs= array(
		...
		'UPLOADPATH_SELF'=>'uploads/microblog/',//上传图片新路径
		...
		'MODULE_ALLOW_LIST'  => array('Admin','Portal','Asset','Api','User','Comment','Blog','Teacher','Weixin','Apps'),
		...
		'SP_WEIXIN_STYLE'		=> 'wx',
		'SP_WEIXIN_TMPL_PATH'    => 'tpl_weixin/',       // 各个项目后台模板文件根目录
		'SP_WEIXIN_DEFAULT_THEME'=> 'simpleboot',       // 各个项目后台模板文件
		'SP_WEIXIN_TMPL_ACTION_ERROR' 	=> 'Weixin/error.html', // 默认错误跳转对应的模板文件,注：相对于后台模板路径
		'SP_WEIXIN_TMPL_ACTION_SUCCESS' 	=> 'Weixin/success.html', // 默认成功跳转对应的模板文件,注：相对于后台模板路径
		'SP_TEACHER_STYLE'		=> 'xc',
		'SP_TEACHER_TMPL_PATH'    => 'tpl_teacher/',       // 各个项目后台模板文件根目录
		'SP_TEACHER_DEFAULT_THEME'=> 'simpleboot',       // 各个项目后台模板文件
		'SP_TEACHER_TMPL_ACTION_ERROR' 	=> 'Teacher/error.html', // 默认错误跳转对应的模板文件,注：相对于后台模板路径
		'SP_TEACHER_TMPL_ACTION_SUCCESS' 	=> 'Teacher/success.html', // 默认成功跳转对应的模板文件,注：相对于后台模板路径
		...
		'HTML_FILE_SUFFIX'  =>    '.html', // 设置静态缓存文件后缀
		 ...
		 // 上传图片新路径
        'TMPL_PARSE_STRING_SELF'=>array(
        	'/public/upload'=>'/uploads/microblog',
        	'__UPLOAD__' => __ROOT__.'uploads/microblog/',
