...
KindEditor.ready(function(K) {
    uploadFile(K, 'upload_logo', 'img_file', "index.php?g=Proscenium&m=Admin&a=uploadImg_droom_cj");
});
    ...
    var uploadImg = obj.uploadbutton({
        ...
        afterUpload : function(data){
             if (data.error === 0) {
                ...
                var imgHtml = '<img src="'+url+'" style="width:220px; height: 123px;" id="img" alt="">';
                if(temp == ''){
